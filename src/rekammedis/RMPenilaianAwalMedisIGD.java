...
public final class RMPenilaianAwalMedisIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-08-2022 10:15:42" }));
        ...
        BtnDokter2.setBounds(390, 880, 140, 23);
        ...
        BtnDokter3.setBounds(640, 880, 150, 23);
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("lokalisortho",Sequel.cariGambar("select lokalisortho from gambar"));
